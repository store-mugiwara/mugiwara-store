<template>
  ...
  <div class="max-w-md w-full space-y-8">
    ...
    <form @submit.prevent="handleSubmit" class="mt-8 space-y-6">
      ...
      <div class="flex">
        <a @click="closeForm" href="#" class="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-gray-500 hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
